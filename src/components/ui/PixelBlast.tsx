...
const PixelBlast: React.FC<PixelBlastProps> = ({
  variant = 'square',
  pixelSize = 3,
  color, // Default color handled with useTheme internally below
  className,
  style,
  antialias = true,
  patternScale = 2,
  ...
  // Theme logic to ensure it looks good on light and dark mode
  const { resolvedTheme } = useTheme();
  const activeColor = color ?? (resolvedTheme === 'light' ? '#7e22ce' : '#B497CF');
